  ...
  <div className="min-h-[calc(100vh-4rem)]">
    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md text-white border border-white/30 rounded-full px-4 py-1.5 text-sm font-medium mb-6">
          <Brain className="h-4 w-4" />
          AI-Powered Healthcare
        </div>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-white drop-shadow-xl">
          AI-powered Sleep Apnea & Sleep Quality Prediction
        </h1>
        <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto font-body drop-shadow-sm">
